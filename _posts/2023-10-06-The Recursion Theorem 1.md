...
math: true
---
This part covers the construction of a Turing Machine (TM) that prints the description of itself. The next part is more worthy of the name and covers the implementation of actual recursion in TMs.
